...
int main() {
    ...
    while(1) {
        ...
        sprintf(m, "Temp: %d", data_arr[0]);
        drawString(10, 10, RED, m);
        //writeUART1(m);
        
        sprintf(m, "Angular Velocity: %d %d %d", data_arr[1], data_arr[2], data_arr[3]);
        drawString(10, 20, GREEN, m);
        //writeUART1(m);
        
        sprintf(m, "Acceleration: %d %d %d", data_arr[4], data_arr[5], data_arr[6]);
        drawString(10, 30, BLUE, m);
        
        sprintf(m, "-----------------");
        drawString(10, 40, WHITE, m);
        //writeUART1(m);
