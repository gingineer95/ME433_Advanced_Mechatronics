...
def FFT_plot(filename, A, B):
    ...
    fig.suptitle('IIR with Weights A= ' + str(A) + ' and B= ' + str(B), fontsize=14, fontweight='bold')
...
FFT_plot('sigA.csv', 0.998, 0.002)
FFT_plot('sigB.csv', 0.95, 0.05)
FFT_plot('sigC.csv', 0.95, 0.05) 
FFT_plot('sigD.csv', 0.95, 0.05)
plt.show()